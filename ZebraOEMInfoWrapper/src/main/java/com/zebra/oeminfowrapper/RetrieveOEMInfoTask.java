...
class RetrieveOEMInfoTask extends ExecutorTask<Object, Void, Boolean> {
    ...
    private static void RetrieveOEMInfo(final Context context, final Uri uri, final IResultCallbacks callbackInterface) {
        ...
        if (cursor == null || cursor.getCount() < 1)
        {
            ...
            registerCurrentApplication(context, uri, new IResultCallbacks() {
                @Override
    ...
    private static void registerCurrentApplication(Context context, Uri serviceIdentifier, IResultCallbacks callbackInterface)
    {
